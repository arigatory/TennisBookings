...
public class IndexTests
{
	...
	{
		var sut = new IndexModel(new SunForecaster(), NullLogger<IndexModel>.Instance, new EnableConfig());
	...
	{
		var sut = new IndexModel(new RainForecaster(), NullLogger<IndexModel>.Instance, new EnableConfig());
	...
	private class EnableConfig : IOptionsSnapshot<FeaturesConfiguration>
	{
